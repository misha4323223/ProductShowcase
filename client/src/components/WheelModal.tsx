  ...
  return (
    <>
      <Dialog open={open && !showPrizeModal} onOpenChange={onClose}>
        <DialogContent className="w-[95vw] max-w-3xl max-h-[90vh] p-0 gap-0 flex flex-col !z-[99999] !top-4 !left-[50%] !-translate-x-1/2 !translate-y-0" data-testid="dialog-wheel">
