                  ...
                  <div className="space-y-2.5 text-[11px]">
                    ...
                    <div>
                      ...
                      <div className="space-y-0.5 text-[10px]">
                        ...
                        <div>• 2💎 → + Товар -20% (на случайный товар из вишлиста)</div>
                        <div>• 3💎 → + Бонусы +200₽ (на баланс)</div>
                        <div>• 4💎 → + Доставка бесплатно (на заказ)</div>
                        <div>• 5💎 → + Товар БЕСПЛАТНО (самый дешёвый из вишлиста, до 500₽)</div>
                        <div className="font-semibold text-orange-600 dark:text-orange-400">• 6+💎 → 🔥 ДЖЕКПОТ 40% (на весь вишлист)</div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1 pt-1">
                      ...
                      <div className="space-y-1 text-[10px]">
                        ...
                        <div>
                          <p className="font-semibold">В: Нужен вишлист?</p>
                          <p className="text-muted-foreground ml-2">О: Да! Некоторые призы работают только с ним ❤️</p>
                        </div>
                      </div>
                    </div>
                  </div>
