...
export default function LegalDialog({ isOpen, onClose, type }: LegalDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-2xl sm:max-w-3xl max-h-[90vh] p-0 flex flex-col" data-testid={`dialog-${type}`}>
        <DialogHeader className="flex-shrink-0 p-3 sm:p-4 md:p-6">
        ...
        <div className="flex-1 overflow-y-auto px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4">
        ...
        <div className="flex flex-col gap-2 p-3 sm:p-4 md:p-6 border-t flex-shrink-0">
          <Link 
