...
export default function LegalDialog({ isOpen, onClose, type }: LegalDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-2xl sm:max-w-3xl max-h-[85vh] sm:max-h-[90vh] p-3 sm:p-4 md:p-6 flex flex-col overflow-y-auto" data-testid={`dialog-${type}`}>
        ...
        <div className="flex flex-col gap-2 pt-2 sm:pt-3 md:pt-4 border-t flex-shrink-0">
          <Link 
