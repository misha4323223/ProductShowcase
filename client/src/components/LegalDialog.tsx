...
export default function LegalDialog({ isOpen, onClose, type }: LegalDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-2xl sm:max-w-3xl max-h-[90vh] p-0 gap-0 flex flex-col" data-testid={`dialog-${type}`}>
        <DialogHeader className="px-4 sm:px-6 py-3 sm:py-4 border-b flex-shrink-0">
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3">
            ...
            <DialogTitle className="text-sm sm:text-base md:text-xl font-serif text-primary" data-testid={`title-${type}`}>
