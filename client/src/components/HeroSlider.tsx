...
export default function HeroSlider({ slides }: HeroSliderProps) {
  ...
  return (
    <>
      <div className="relative w-full h-[60vh] md:h-[768px] max-h-[1500px] md:max-h-[768px] overflow-hidden bg-gradient-to-br from-pink-50 to-purple-50 pt-4 md:pt-0 hero-mobile-fix">
          ...
          >
            <OptimizedImage
              ...
              className={`w-full h-full object-cover hero-slide-image ${
                slide.id === 1 ? 'object-top' : slide.id === 2 ? 'object-center hero-slide-2-mobile' : slide.id === 3 ? 'object-bottom' : 'object-center'
              }`}
            />
