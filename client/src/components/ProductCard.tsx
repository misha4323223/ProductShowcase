...
export default function ProductCard({
  ...
  return (
    ...
    >
      ...
      <div className="p-4 space-y-3 bg-gradient-to-b from-white via-pink-50/20 to-white dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 relative caramel-drip">
