...
export default function FaqPage() {
  ...
  // FAQ данные для Schema.org разметки
  const faqData = [
    {
      question: "Как оформить заказ?",
      answer: "Чтобы оформить заказ: 1) Выберите понравившиеся товары и добавьте их в корзину. 2) Перейдите в корзину и нажмите «Оформить заказ». 3) Заполните форму с контактными данными и адресом доставки. 4) Выберите способ оплаты и доставки. 5) Подтвердите заказ. После оформления вы получите письмо с подтверждением на указанный email."
    },
    {
      question: "Какие способы оплаты доступны?",
      answer: "Мы принимаем следующие способы оплаты: Карты МІР - российские банковские карты (онлайн оплата), СБП - Система Быстрых Платежей (перевод по номеру телефона). Все платежи защищены и проходят через безопасное соединение."
    },
    {
      question: "Как работает доставка?",
      answer: "Доставляем по всей России с помощью транспортных компаний: СДЭК, Боксберри, Яндекс Доставка. Доставка до пункта выдачи или курьером до двери. Сроки: 2-10 дней по России. Стоимость: от 150₽ (рассчитывается при заказе)."
    },
    {
      question: "Можно ли вернуть или обменять товар?",
      answer: "Согласно законодательству РФ (Постановление Правительства № 2463 от 31.12.2020), продовольственные товары надлежащего качества (шоколад, конфеты, печенье, мармелад и другие сладости) не подлежат возврату и обмену. Возврат возможен только для товара ненадлежащего качества: при производственном браке, истекшем сроке годности (менее 7 дней), нарушении целостности упаковки при доставке, несоответствии описанию на сайте. Для возврата сфотографируйте товар, свяжитесь с нами по телефону или email, опишите проблему. Мы рассмотрим заявку в течение 24 часов. Возврат денег в течение 3-5 рабочих дней."
    },
    {
      question: "Как отследить мой заказ?",
      answer: "Отследить статус заказа можно несколькими способами: 1) Проверьте email - мы отправим на него трек-номер. 2) Войдите в Личный кабинет → раздел Мои заказы. 3) Позвоните нам или напишите - сообщим актуальный статус."
    },
    {
      question: "Как использовать промокод?",
      answer: "Чтобы использовать промокод: 1) Добавьте товары в корзину. 2) Перейдите к оформлению заказа. 3) Найдите поле Промокод в форме оформления. 4) Введите код и нажмите Применить. 5) Скидка автоматически пересчитается. Промокоды можно получить в рассылке, соцсетях или на специальных акциях."
    },
    {
      question: "Как правильно хранить сладости?",
      answer: "Шоколад: хранить при температуре 15-18°C в тёмном месте. Конфеты: в сухом прохладном месте, избегать прямых солнечных лучей. Печенье: в герметичной упаковке при комнатной температуре. Сроки годности указаны на каждом товаре. Рекомендуем употребить в течение этого периода."
    },
    {
      question: "Как с нами связаться?",
      answer: "Мы всегда рады помочь! Телефон: +7 953 181 41 36 (ежедневно 11:00-18:00). Email: Storesweeet@gmail.com. Адрес: г. Фантазия ул. Сладкая, 8. Обычно отвечаем в течение 1-2 часов в рабочее время."
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col candy-pattern">
      <SEO
        title="Частые вопросы - Sweet Delights | Ответы на популярные вопросы"
        description="Ответы на частые вопросы о доставке, оплате, возврате товаров в интернет-магазине Sweet Delights. Как оформить заказ, способы оплаты, условия возврата продовольственных товаров."
        keywords="часто задаваемые вопросы, FAQ, доставка сладостей, оплата заказа, возврат товара, условия доставки, Sweet Delights"
        canonical="/faq"
