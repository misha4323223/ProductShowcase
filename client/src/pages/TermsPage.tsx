    ...
    <div className="min-h-screen flex flex-col candy-pattern">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-8 md:py-12">
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <span data-testid="text-current-page">Договор оферты</span>
        </div>
        ...
        <Card className="shadow-lg" data-testid="card-terms-content">
          <CardContent className="prose prose-sm max-w-none p-6 md:p-8 space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                <li><strong>Курьерская доставка</strong> — доставка по указанному адресу в течение 1-3 рабочих дней</li>
                <li><strong>Почта России</strong> — доставка почтовым отправлением в течение 5-14 рабочих дней</li>
                <li><strong>Самовывоз</strong> — получение товара по адресу пункта выдачи</li>
              </ul>
              <p className="text-muted-foreground leading-relaxed mt-3">
